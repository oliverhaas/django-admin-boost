...
from django_admin_boost.unfold.admin import StackedInline, TabularInline
from django_admin_boost.unfold.contrib.inlines.checks import NonrelatedModelAdminChecks
from django_admin_boost.unfold.contrib.inlines.forms import (
            ...
            def hand_clean_DELETE(self):
                ...
                if self.cleaned_data.get(DELETION_FIELD_NAME, False):
                    ...
                    if self.instance._state.adding:
                        return
                    collector.collect([self.instance])  # type: ignore
