...
from django_admin_boost.unfold.utils import display_for_field, prettify_json
from django_admin_boost.unfold.widgets import (
...
class UnfoldAdminReadonlyField(helpers.AdminReadonlyField):
    ...
    def _get_contents(self) -> SafeString:  # noqa: PLR0912
        from django_admin_boost.unfold.utils import _boolean_icon
