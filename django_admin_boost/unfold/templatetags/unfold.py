...
from django_admin_boost.unfold.components import ComponentRegistry
from django_admin_boost.unfold.enums import ActionVariant
from django_admin_boost.unfold.sections import BaseSection
