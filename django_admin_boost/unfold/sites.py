...
from django_admin_boost.unfold.dataclasses import DropdownItem, Favicon, SearchResult
...
from django_admin_boost.unfold.settings import get_config
from django_admin_boost.unfold.utils import convert_color
...
class UnfoldAdminSite(AdminSite):
    ...
    def __init__(self, name: str = "admin") -> None:
        from django_admin_boost.unfold.forms import AuthenticationForm
    ...
    def password_change(
        ...
        from django_admin_boost.unfold.forms import AdminOwnPasswordChangeForm
