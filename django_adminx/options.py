...
from django_adminx import helpers, widgets
from django_adminx.checks import (
    BaseModelAdminChecks,
    InlineModelAdminChecks,
    ModelAdminChecks,
)
from django_adminx.exceptions import DisallowedModelAdminToField, NotRegistered
...
from django_adminx.widgets import AutocompleteSelect, AutocompleteSelectMultiple
...
class BaseModelAdmin(metaclass=forms.MediaDefiningClass):
    ...
    def lookup_allowed(self, lookup, value, request):
        from django_adminx.filters import SimpleListFilter
...
class ModelAdmin(SmartPaginatorMixin, ListOnlyFieldsMixin, BaseModelAdmin):
    ...
    save_on_top = False
    # paginator is set by SmartPaginatorMixin (EstimatedCountPaginator)
    ...
    def get_changelist(self, request, **kwargs):
        ...
        """
        from django_adminx.views.main import ChangeList
    ...
    def log_addition(self, request, obj, message):
        ...
        """
        from django_adminx.models import ADDITION, LogEntry
    ...
    def log_change(self, request, obj, message):
        ...
        The default implementation creates an admin LogEntry object.
        """
        from django_adminx.models import CHANGE, LogEntry
    ...
    def log_deletions(self, request, queryset):
        ...
        """
        from django_adminx.models import DELETION, LogEntry
    ...
    def message_user(
        ...
        if not isinstance(level, int):
            ...
            try:
                ...
                raise ValueError(
                    "Bad message level string: `%s`. Possible values are: %s" % (level, levels_repr),
                )
    ...
    def _get_edited_object_pks(self, request, prefix):
        ...
        pk_pattern = re.compile(
            rf"{re.escape(prefix)}-\d+-{self.opts.pk.name}$",
        )
    ...
    def changelist_view(self, request, extra_context=None):
        ...
        """
        from django_adminx.views.main import ERROR_FLAG
    ...
    def history_view(self, request, object_id, extra_context=None):
        ...
        from django_adminx.views.main import PAGE_VAR
    ...
    def _create_formsets(self, request, obj, change):
        ...
        for FormSet, inline in self.get_formsets_with_inlines(*get_formsets_args):
            ...
            def user_deleted_form(request, obj, formset, index, inline):
                ...
                return inline.has_delete_permission(request, obj) and f"{formset.prefix}-{index}-DELETE" in request.POST
